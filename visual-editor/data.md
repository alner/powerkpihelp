...
*   ****![](../.gitbook/assets/image%20%2850%29.png)- **delete selected cell/cells binding** \(dimensions, measures, text, icons, images etc.\)
...
For table-like templates you will have to select row numbers which correspond to details rows, and then to click on “Rows” tag ![](../.gitbook/assets/image%20%2880%29.png).

In such a way you will always have to tag details rows for table-like templates:

![](../.gitbook/assets/2019-04-02_10-53-45.gif)

If you need to change your markup, you can click on ![](../.gitbook/assets/image%20%2816%29.png) icon to remove markup and to tag your rows in a different way.
...
* \*\*\*\*![](../.gitbook/assets/image%20%2849%29.png) ****- **insert an icon into the selected cell**
...
* ![](../.gitbook/assets/image%20%28112%29.png)- **insert an image** in the selected cell from a content library
...
Image ![](../.gitbook/assets/image%20%2867%29.png) button will allow you to select an image from one of the predefined content library.
