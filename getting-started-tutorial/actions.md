...
Open “KPIs” template in edit mode by clicking ![](../.gitbook/assets/image%20%287%29.png)button on top left corner. Open “Actions” panel by clicking "Actions" ![](../.gitbook/assets/image%20%2883%29.png) toolbar button \(or use "Ctrl + Shift + A" keyboard shortcut to do the same\). 
