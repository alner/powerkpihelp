...
To horizontally center all data inside each selected cell, click "Center" ![](../.gitbook/assets/image%20%2826%29.png)  toolbar button \(or use "Ctrl + J" keyboard shortcut\).

Apply vertical middle alignment clicking "Middle"![](../.gitbook/assets/image%20%2823%29.png) toolbar  button \(or use "Ctrl + Alt + J" keyboard shortcut\).
...
Let's apply another font on our KPIs. Return to edit mode by clicking "New visualization" tab ![](../.gitbook/assets/image%20%2844%29.png) . Cell selections should still remain active. Change font to Comfortaa, for example.
