...
Open “KPIs” template in edit mode by clicking ![](../.gitbook/assets/image%20%2811%29.png)button on top left corner. Open “Actions” panel by clicking "Actions" ![](../.gitbook/assets/image%20%28114%29.png) toolbar button \(or use "Ctrl + Shift + A" keyboard shortcut to do the same\). 
...
Select it and click “Apply” button. “Activate view” item will be shown on the “Actions” panel and a special icon ![](../.gitbook/assets/image%20%2840%29.png) will be shown in top left corner of the selected cell.

![](../.gitbook/assets/tutorial37.png)

Save all changes clicking "Save" ![](../.gitbook/assets/image%20%2815%29.png) button.
